    ...
    Public.showWaitingLayer = function(){
        ...
        if(_waitingDivObj == null){
            ...
            var tableStr = "<TABLE width=\"100%\" height=\"100%\"><TR><TD align=\"center\" valign=\"middle\"><span style=\"border:1px solid #7998B7;width:186pxpx;height:22px;background:#FFFFFF;padding:2px\"><span style=\"position:relative;left:0px;top:4px;*left:3px;*top:-2px;\"><img src=\""+__WAITING_IMG_PATH+"loading_16x16.gif\" /></span><span style=\"font:normal 12px '宋体';color:#2B61BA; height:22px; padding:0px 2px 0px 5px;*padding:5px 2px 0px 0px;\">数据加载中,请稍候...</span></span></TD></TR></TABLE>";
            tableStr += "<div style=\"background:black;filter:alpha(opacity=0);-moz-opacity:0;-khtml-opacity:0;width:100%;height:100%;position:absolute;left:0;top:0;z-index:10000;\"></div>";
